...
<html>
    ...
    <body>
        <form action="menuController" method="GET">
            ...
            <a id="cadcli"  href="ClienteController?acao=listar">Cadastro Cliente</a>
            <a id="vendas"  href="vendaController?acao=vendas">Vendas</a>
            <a id="ra"      href="RelatorioAnaliticoController?acao=relatorios">Relatório Analitico</a>
            <a id="rs"      href="RelatorioSinteticoController?acao=relatorio">Relatório Sintético</a>
            ...
            <div class="barra">
                <nav>
                    ...
                    <a href="loginController?acao=login">
