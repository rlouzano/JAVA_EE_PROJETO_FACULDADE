...
<html>
    ...
    <body>
        <a id="txtCad" href="UsuarioController?acao=usuario">Cadastrar Usuário</a>
                ...
                <table>
                    ...
                    <c:forEach var="u" items="${user}">
                        <tr id="branco">
                            ...
                            <td>${u.filial}</td>
                            <td>${u.idfilial}</td>
                            <td><a href="javascript:confirmarAlteracao(${u.id});">EDITAR</a> - <a href="javascript:confirmarExclusao(${u.id});">EXCLUIR</a>
                        </tr>
                    </c:forEach>
                </table>
            </form>
